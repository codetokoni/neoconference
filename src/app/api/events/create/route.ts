...
export async function POST(req: NextRequest) {
  ...
  let body: CreateBody;
  try {
    body = (await // src/app/api/events/create/route.ts
// One-call event provisioning: builds the LiveKit room name, optional StreamLab
// stream, optional HSMOH shortlink, and persists the NeoEvent to KV.
...
req.json()) as CreateBody;
  ...
  if (!hsmohBinding) {
    // Fallback: use our own /e/<slug> as the canonical short url.
