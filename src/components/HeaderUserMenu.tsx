    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-64 rounded-xl bg-zinc-950/95 backdrop-blur border border-cyan-400/20 shadow-2xl text-white overflow-hidden z-50">
          ...
          <Link href="/" onClick={() => setOpen(false)} className="block px-4 py-2 text-sm hover:bg-white/5">Home</Link><Link href="/dashboard/recordings" onClick={() => setOpen(false)} className="block px-4 py-2 text-sm hover:bg-white/5">Recordings</Link>
